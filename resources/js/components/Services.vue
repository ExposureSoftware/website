                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="our-services-tab pt-30">
                            <ul class="nav justify-content-center wow fadeIn" data-wow-duration="1s"
                                data-wow-delay="0.5s" id="myTab" role="tablist">
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a id="digital-tab" data-toggle="tab" href="#digital" role="tab"
                                ...
                                <li class="nav-item">
                                    <a id="market-tab" data-toggle="tab" href="#market" role="tab"
                            ...
                            <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="our-services-content mt-45">
                                                ...
                                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                    ...
                                                    placerat at ante. Cras sed consequat justo. Curabitur laoreet eu est
                                                    vel convallis. </p>
                                ...
                                <div class="tab-pane fade" id="digital" role="tabpanel" aria-labelledby="digital-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="our-services-content mt-45">
                                                <h3 class="services-title">Digital Marketing <span>for Your Business Growth.</span>
                                                </h3>
                                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                    Nam nec est arcu. Maecenas semper tortor. <br> <br> In elementum in
                                                    risus sed commodo. Phasellus nisi ligula, luctus at tempor vitae,
                                ...
                                <div class="tab-pane fade" id="market" role="tabpanel" aria-labelledby="market-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="our-services-content mt-45">
                                                <h3 class="services-title">Market Analysis <span>for Your Business Growth.</span>
                                                </h3>
                                                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                    Nam nec est arcu. Maecenas semper tortor. <br> <br> In elementum in
                                                    risus sed commodo. Phasellus nisi ligula, luctus at tempor vitae,
                                                ...
                                                <div class="our-services-progress d-flex align-items-center mt-55">
                                                    ...
                                                    <div class="progress-content">
                                                        <h4 class="progress-title">Market Analysis <br> Agency Skill.
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div> <!-- our services content -->
...
<script>
    ...
    export default {
        name: "Services",
        mounted() {
            const Circles = require('../circles.min')
            const services = $('.our-services-progress');
